				         ...
				         <div className="timeline-centered">
					         ...
					         <article className="timeline-entry animate-box" data-animate-effect="fadeInTop">
					            <div className="timeline-entry-inner">
					               ...
					               <div className="timeline-label">
					               	<h2><a href="#">Web Development</a> <span>2018-Sekarang</span></h2>
					                  <p>Saya cukup berpengalaman pada bidang web development. ada banyak project yang saya sudah kerjakan, mulai dari membuat company profile suatu bisnis, membuat personal website, ataupun membuat blog untuk keperluan tertentu.</p>
					               </div>
					            </div>
					         </article>
