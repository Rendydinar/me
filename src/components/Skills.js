				...
				<div className="colorlib-narrow-content">
					<div className="row">
						<div className="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
							<span className="heading-meta">KEKAYAAN SAYA</span>
							<h2 className="colorlib-heading animate-box">KEMAMPUAN SAYA</h2>
						</div>
					</div>
					<div className="row">
						<div className="col-md-12 animate-box" data-animate-effect="fadeInLeft">
							<p>Dalam membangun suatu aplikasi atau website, ada beberapa hal yang harus saya lakukan. Pertama melihat teknologi apa yang sesuai untuk membuat suatu aplikasi, untuk itu saya harus belajar banyak mengenai teknologi yang dapat digunakan dalam membangun suatu website atau aplikasi berbasis web.</p>
						</div>
